  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(children: [
        Row(
          children: [Text(appoiment.doctor ?? ''), Text(appoiment.date ?? '')],
        ),
        Text(appoiment.start.toString() + 'to '+ appoiment.end.toString())
      ]),
    );
  }
}
...
class DialogFb3 extends StatelessWidget {
  DialogFb3({Key? key, required this.appoiment}) : super(key: key);
  // final String date ;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text((appoiment.start  + 'to ' +appoiment.end ),
                style: TextStyle(
                    color: accentColor,
                    fontSize: 12,
                    fontWeight: FontWeight.w300)),
