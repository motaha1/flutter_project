...
class appoiment_show_doctor_firebase extends StatefulWidget {
  appoiment_show_doctor_firebase({Key? key, this.title}) : super(key: key);
  final String? title;
...
class _MyHomePageState extends State<appoiment_show_doctor_firebase> {
                ...
                Container(
                  child: DatePicker(
                    ...
                    onDateChange: (date) async {
                      ...
                      await provider.getAllappoiment_doctor();
                      EasyLoading.dismiss();
                    },
                  ),
                ),
