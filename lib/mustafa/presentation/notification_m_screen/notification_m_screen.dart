...
import 'package:final_grad_proj/mustafa/presentation/evaluation_dialog/evaluation_dialog.dart';
                      ...
                      children: [
                        Align(
                            ...
                            child: Container(
                                width: size.width,
                                margin:
                                    EdgeInsets.only(top: 48.h, bottom: 20.h),
                                child: Padding(
    ...
    return GestureDetector(
      onLongPress: () {
        Get.defaultDialog(
            ...
            onCancel: () {},
            title: notify.title ?? '',
            middleText: notify.msg ?? '');
      },
      onTap: () {
        Get.defaultDialog(
          title: 'New Ratting',
           content:EvaluationDialog()
           // RatingBar.builder(
          //   //ignoreGestures: true,
          //   itemSize: 15.0,
          //   initialRating: 0,
          ...
          onConfirm: () async {
            ...
            EasyLoading.dismiss();
            EasyLoading.showSuccess('DONE , THANK YOU FOR RATING');
                            ...
                            children: [
                              ...
                              Align(
                                  ...
                                  child: Padding(
                                      ...
                                      child: Text(
                                          notify.createdAt ?? '1-1-2023',
                                          overflow: TextOverflow.ellipsis,
                                          textAlign: TextAlign.left,
                                          style:
                                              AppStyle.txtOverpassRegular13)))
                            ]))),
              ]))),
    );
  }
